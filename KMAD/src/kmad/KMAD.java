...
/**
		...
		J48.process();
		ArrayList<SpecTuple> filteredTraining = new ArrayList<SpecTuple>();
		Genetic genetic = new Genetic(delta, J48.candidates);
		genetic.run(evalFile, filteredTraining, filteredCandJ48);
...
//		genetic.run(evalFile, best, filteredCandJ48);
